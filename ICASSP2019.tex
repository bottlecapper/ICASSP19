...
\name{Jian Gao $^{\star}$ \qquad Deep Chakraborty $^{\dagger}$ \qquad Olaitan Olaleye $^{\ddagger}$ \qquad Hamidou Tembine $^{\star}$}
...
%Future work is to develop a unified general model for multi-domain emotion conversion for unseen speakers.
